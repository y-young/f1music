...
const Home = () => {
  return (
    <div>
      ...
      <p>
        审核流程：初步筛选(删除不符合硬性规定的曲目) ->
        二次筛选(根据各时段曲目要求筛选掉不符合要求的曲目，移至回收站) ->
        核查&复查 -> 精选(每一时段留下10首左右精选曲目，供公开投票使用)
      </p>
      <hr />
      ...
      <ol>
        ...
        <li>
          熄灯音乐：能让想睡的人睡觉，让想夜读的人能继续夜读，歌曲时长不宜过长。
        </li>
      </ol>
      <hr />
      ...
      <ol>
        ...
        <li>
          审核的最终目的在于每一时段精选10首左右歌曲以节省公开投票时间，原则上审核结束后每一时段歌曲不超过10首，但如有本校学生原创歌曲不计入10首限制内。
        </li>
      </ol>
    </div>
  );
