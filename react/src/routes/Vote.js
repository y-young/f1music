...
import { Alert, Button, Form, Modal, Radio, Result, Spin, Switch } from "antd";
import { PhaseCountdown, TimeSelector, VoteList } from "components";
          ...
          : (
            <div>
              <Alert
                type="info"
                closable
                description={<PhaseCountdown title="距离投票结束" value={status.end} />}
