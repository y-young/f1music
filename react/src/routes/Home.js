      ...
      <Tabs defaultActiveKey="upload">
        <TabPane tab="上传说明" key="upload">
          ...
          <p>
            ...
            ，最好不带有任何人声。同时，请各位在挑选音乐的时候明确自己对全体师生的责任，在依据自身审美标准的同时考虑广大人民群众的需求，即歌曲须符合当代中学生审美并且能被大多数同学所接受。
          </p>
          <hr />
        ...
        <TabPane tab="投票说明" key="vote">
          ...
          <p>
            投票时请先选择一个时段，待页面加载完毕后展开播放器，歌曲播放总时长达30秒后允许提交投票，请综合您的感受及歌曲所在时段的音乐要求进行评价，选择“1星
          ...
          <p>
            部分浏览器不支持此功能，如您在使用时发生错误，请在投票页面右上角关闭自动播放功能并尝试手动播放。
          </p>
          <hr />
          <p>
