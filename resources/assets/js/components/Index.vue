    ...
    <div>
        ...
        <el-tabs v-model="help">
            ...
            <el-tab-pane label="投票说明" name="vote">
                ...
                <ul>
                    <li>展开播放器后自动开始播放</li>
                    <li>手动提交投票或播放完毕自动提交成功后自动切换到下一首,并开始播放(不跨时段,部分览器不兼容)</li>
                </ul>
                ...
                <router-link to="/Vote/1" style="font-size: 14px; color: #777;">前往投票 <i class="el-icon-arrow-right"></i></router-link>
            </el-tab-pane>
            <el-tab-pane label="各时段音乐要求" name="requirement">
                ...
                <ol>
                    ...
                    <li>晚出门音乐：暂无额外要求。</li>
                    <li>自习结束音乐：暂无额外要求。</li>
                    <li>熄灯音乐：能让想睡的同学睡觉，让想夜读的同学能继续夜读。</li>
                </ol>
            </el-tab-pane>
        </el-tabs>
        </div>
