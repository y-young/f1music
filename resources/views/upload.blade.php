...
@section('contents')
    ...
    <h3>上传</h3>
    <el-form :model="ruleForm" label-position="left" :rules="rules" ref="ruleForm" label-width="80px">
        ...
        <el-form-item label="上传文件" prop="file">
            <el-upload class="upload-demo" v-model="ruleForm.file" accept="audio/mpeg" :data="ruleForm" :before-upload="beforeUpload" :on-success="onSuccess" drag action="/Upload">
